...
def _transcript(segments: list[TranscriptSegment], lang: str) -> Transcript:
    return Transcript(
        ...
        language=lang,
        segments=segments,
        models=TranscriptModels(asr_provider="asr.fake", asr_model="fixture"),
        created_at=_T0,
    )
    ...
    for i in range(8):
        ...
        samples.append(
            Sample(
                ...
                visual_analysis=_va(
                    [(0, ["person"]), (4000, ["screen_record"]), (9000, ["product"])]
                ),
            )
        )
    ...
    for i in range(6):
        ...
        samples.append(
            Sample(
                ...
                visual_analysis=_va(
                    [(0, ["person"]), (3500, ["screen_record"]), (8000, ["person"])]
                ),
            )
        )
