...
INVALID_OVERRIDES: list[tuple[str, str, dict[str, Any]]] = [
    ...
    ("learning-signal-result", "association_only False 被拒",
     {"association_only": False}),
    ("learning-signal-result", "样本不足却给方向被拒",
    ...
    ("ranker-weights", "系数为负被拒",
     {"coefficients": {"hook_strength": -0.1}}),
    ("ranker-weights", "系数为空被拒", {"coefficients": {}}),
    ("calibration-proposal", "EXPLORE 却 promotable=False 被拒",
     {"promotable": False, "decision": "EXPLORE", "exploration_fraction": 0.1}),
    ("calibration-proposal", "探索比例超硬上限被拒",
     {"exploration_fraction": 0.5}),
    ("calibration-proposal", "放宽 max 探索上限被拒（只能收紧）",
     {"max_exploration_fraction": 1.0, "exploration_fraction": 1.0}),
    ("calibration-proposal", "非 EXPLORE 却带探索流量被拒",
     {"decision": "KEEP_CURRENT", "exploration_fraction": 0.1, "promotable": False}),
    ("calibration-proposal", "非法 CalibrationDecision 被拒",
    ...
    ("source-asset", "IMPORTED 却无 file_sha256 被拒",
     {"disposition": "IMPORTED", "file_sha256": None}),
    ("source-asset", "UNRESOLVABLE 却无 error_code 被拒",
     {"disposition": "UNRESOLVABLE", "error_code": None}),
    ("source-asset", "非法处置枚举被拒", {"disposition": "DOWNLOADED"}),
    ("source-asset", "attempts 缺 connector 被拒",
     {"acquisition": {"tool_name": "download.router",
                        "attempts": [{"status": "unconfigured"}]}}),
